  ...
  const handleSendMessage = async () => {
    ...
    setTimeout(async () => {
      ...
      const aiMessage: Message = {
        ...
        type: 'ai',
        content: 'I\'ve generated some engaging content for your social media post. You can edit the text and hashtags below:',
        generatedContent,
      };
      ...
      <div className="flex-1 overflow-auto p-4 space-y-4">
        {messages.length === 0 && (
          <div className="text-center text-muted-foreground py-12">
            ...
            <p className="text-sm mt-2">For example: "Create a post about our new product launch"</p>
          </div>
        )}
        ...
        {messages.map((message) => (
          <div key={message.id} className={`flex gap-3 ${message.type === 'user' ? 'justify-end' : ''}`}>
            ...
            <Card className={`max-w-2xl rounded-2xl ${message.type === 'user' ? 'bg-primary text-primary-foreground' : ''}`}>
                  ...
                  <div className="mt-4 space-y-4">
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={(e) => setEditableContent(prev => prev ? {...prev, text: e.target.value} : null)}

...
import { Bell, Facebook, Instagram, Linkedin, Palette, Shield, Twitter, User } from "lucide-react";
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Card
                    className="p-4 cursor-pointer border border-border rounded-xl hover:border-primary"
                    onClick={toggleTheme}
                  >

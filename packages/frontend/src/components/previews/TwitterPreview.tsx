    ...
    <Card className="w-full max-w-lg rounded-2xl border border-border shadow-sm">
      <CardContent className="p-4">
        ...
        <div className="flex items-center justify-between text-muted-foreground max-w-md">
          <Button variant="ghost" size="sm" className="h-8 px-2 rounded-full hover:bg-blue-50 hover:text-blue-500">
            <MessageCircle className="h-4 w-4 mr-2" />
            <span className="text-sm">12</span>
          </Button>
          <Button variant="ghost" size="sm" className="h-8 px-2 rounded-full hover:bg-green-50 hover:text-green-500">
            <Repeat2 className="h-4 w-4 mr-2" />
            <span className="text-sm">5</span>
          </Button>
          <Button variant="ghost" size="sm" className="h-8 px-2 rounded-full hover:bg-red-50 hover:text-red-500">

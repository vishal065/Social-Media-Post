...
class ApiErrorHandler extends Error {
  ...
  constructor(
    ...
    const isProduction = EnvSecret.NODE_ENV === (EApplicationEnviroment.PRODUCTION as string);
...
const ApiError = (statusCode: number, message: string, req: Request | null, errors: any[] = []) => {
